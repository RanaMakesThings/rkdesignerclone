...
await yargs(hideBin(process.argv))
  ...
  .option("out", {
    type: "string",
    demandOption: true,
    describe: "Output directory for per-slide PDFs plus deck.pdf.",
  })
  .option("slide", {
    type: "array",
  ...
  .then(async (argv) => {
    ...
    const payload = {
      ...
      deckPdfPath: result.deckPdfPath,
    ...
    process.stdout.write(`${payload.deckPdfPath}\n`);
  });
