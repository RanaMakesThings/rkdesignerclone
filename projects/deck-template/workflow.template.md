...
Project-local workflow for building a deck under `projects/<project>/`.
...
- per-slide:
  - `npm run figures:report -- --project-root projects/<project> --slide <slide-id>`
- whole deck:
  - `npm run figures:deck-report -- --project-root projects/<project>`
